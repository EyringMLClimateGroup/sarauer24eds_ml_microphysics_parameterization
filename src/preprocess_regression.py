...
np.save("/work/bd1179/b309246/phd_thesis/sarauer23_microphysics_parametrization/pytorch_nextgems/data/df_nextgems_mig_subset_regression_train.npy", set_train)
np.save("/work/bd1179/b309246/phd_thesis/sarauer23_microphysics_parametrization/pytorch_nextgems/data/df_nextgems_mig_subset_regression_val.npy", set_val)
np.save("/work/bd1179/b309246/phd_thesis/sarauer23_microphysics_parametrization/pytorch_nextgems/data/df_nextgems_mig_subset_regression_test.npy", set_test)
